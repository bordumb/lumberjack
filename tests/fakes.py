...
The recording doubles below are the same idea pointed the other way: :class:`RecordingTelemetry`
keeps what the harness *emitted*, so a test can assert on instrument and attribute names --
the part of telemetry that a rename breaks silently.
"""
